...
_CONFIGS = [
    ...
    TrainConfig(
        name="pi05_b1k-ki-vqa-pick_hand-6w-cosine-from-all-skills-50k",
        exp_name="pi05_ki_vqa_pick_hand_6w_cosine_from_all_skills_50k",
        project_name="B1K_KI",
        model=pi0_config.Pi0Config(
            pi05=True,
            action_horizon=32,
        ...
        data=[
            LeRobotB1KDataConfig(
                repo_id="behavior-1k/2025-challenge-demos",
                assets=AssetsConfig(
                    assets_dir="./outputs/checkpoints/pi05_b1k-all_skills/pi05_b1k-all_skills/49999/assets"
                ),
                base_config=DataConfig(
                    prompt_from_task=True,
                    ...
                    episodes_index=list(range(0, 180)),
                    fine_grained_level=1,
                    skill_list=["pick up from", "hold", "release", "hand over"],
                ),
            ),
            RoboInterVQADataConfig(
                repo_id="RoboInter-VQA",
                local_vqa_root="/root/Training/DATASETS/RoboInter-VQA",
                robointer_annotation_paths=(
                    "Understanding/meta/train/rh20t/contact_decide.json",
                    "Understanding/meta/train/rh20t/grasppose_choice.json",
                    "Understanding/meta/train/rh20t/grounding_choice.json",
            ...
            LocalVQASchemaDataConfig(
                repo_id="RobustVLGuard",
                local_vqa_schema_paths=(
                    "/root/Training/DATASETS/RobustVLGuard/Extracted/comprehensive_4k_openpi_schema.jsonl",
                ),
                base_config=DataConfig(prompt_from_task=False),
            ),
        ],
        sample_weights=[0.85, 0.14, 0.01],
        weight_loader=weight_loaders.CheckpointWeightLoader(
            "./outputs/checkpoints/pi05_b1k-all_skills/pi05_b1k-all_skills/49999/params"
        ),
        ...
        ema_decay=None,
        checkpoint_base_dir="./outputs/checkpoints/pi05_b1k-ki-vqa-pick_hand-6w-cosine-from-all-skills-50k",
        num_workers=16,
        batch_size=8 * 32,
    ),
    TrainConfig(
        name="pi05_b1k-ki-vqa-pick_hand-6w-cosine-flow2vlm-from-all-skills-50k",
        exp_name="pi05_ki_vqa_pick_hand_6w_cosine_flow2vlm_from_all_skills_50k",
        project_name="B1K_KI",
        model=pi0_config.Pi0Config(
            pi05=True,
            action_horizon=32,
            knowledge_insulation=True,
            flow_stop_gradient=False,
            fast_loss_weight=1.0,
            flow_loss_weight=1.0,
            vqa_loss_weight=1.0,
        ),
        ...
        ema_decay=None,
        checkpoint_base_dir="./outputs/checkpoints/pi05_b1k-ki-vqa-pick_hand-6w-cosine-flow2vlm-from-all-skills-50k",
        num_workers=16,
        batch_size=8 * 32,
    ),
    TrainConfig(
        name="pi05_b1k-pick_hand-6w-step-from-all-skills-50k",
        exp_name="pi05_pick_hand_6w_step_from_all_skills_50k",
        project_name="B1K",
        model=pi0_config.Pi0Config(pi05=True, action_horizon=32),
        data=LeRobotB1KDataConfig(
            repo_id="behavior-1k/2025-challenge-demos",
        ...
        freeze_filter=pi0_config.Pi0Config(pi05=True, action_horizon=32).get_freeze_filter(),
        ema_decay=None,
        checkpoint_base_dir="./outputs/checkpoints/pi05_b1k-pick_hand-6w-step-from-all-skills-50k",
        num_workers=8,
        batch_size=8 * 32,
    ),
    TrainConfig(
        name="pi05_b1k-pick_hand-20w-cosine-from-all-skills-50k",
        exp_name="pi05_pick_hand_20w_cosine_from_all_skills_50k",
        project_name="B1K",
        model=pi0_config.Pi0Config(pi05=True, action_horizon=32),
        data=LeRobotB1KDataConfig(
            repo_id="behavior-1k/2025-challenge-demos",
        ...
        freeze_filter=pi0_config.Pi0Config(pi05=True, action_horizon=32).get_freeze_filter(),
        ema_decay=None,
        checkpoint_base_dir="./outputs/checkpoints/pi05_b1k-pick_hand-20w-cosine-from-all-skills-50k",
        num_workers=8,
        batch_size=8 * 32,
    ),
    TrainConfig(
        name="pi05_b1k-place_into-15w-cosine-from-all-skills-50k",
        exp_name="pi05_place_into_15w_cosine_from_all_skills_50k",
        project_name="B1K",
        model=pi0_config.Pi0Config(pi05=True, action_horizon=32),
        data=LeRobotB1KDataConfig(
            repo_id="behavior-1k/2025-challenge-demos",
            ...
            base_config=DataConfig(
                ...
                episodes_index=list(range(0, 180)),
                fine_grained_level=1,
                skill_list=["place in", "place in next to", "insert"],
            ),
        ),
        weight_loader=weight_loaders.CheckpointWeightLoader(
            "./outputs/checkpoints/pi05_b1k-all_skills/pi05_b1k-all_skills/49999/params"
        ...
        freeze_filter=pi0_config.Pi0Config(pi05=True, action_horizon=32).get_freeze_filter(),
        ema_decay=None,
        checkpoint_base_dir="./outputs/checkpoints/pi05_b1k-place_into-15w-cosine-from-all-skills-50k",
        num_workers=8,
        batch_size=8 * 32,
    ),
    TrainConfig(
        name="pi05_b1k-place_surface-15w-cosine-from-all-skills-50k",
        exp_name="pi05_place_surface_15w_cosine_from_all_skills_50k",
        project_name="B1K",
        model=pi0_config.Pi0Config(pi05=True, action_horizon=32),
        data=LeRobotB1KDataConfig(
            repo_id="behavior-1k/2025-challenge-demos",
            ...
            base_config=DataConfig(
                ...
                episodes_index=list(range(0, 180)),
                fine_grained_level=1,
                skill_list=["place on", "place on next to", "place under"],
            ),
        ),
        weight_loader=weight_loaders.CheckpointWeightLoader(
            "./outputs/checkpoints/pi05_b1k-all_skills/pi05_b1k-all_skills/49999/params"
        ...
        freeze_filter=pi0_config.Pi0Config(pi05=True, action_horizon=32).get_freeze_filter(),
        ema_decay=None,
        checkpoint_base_dir="./outputs/checkpoints/pi05_b1k-place_surface-15w-cosine-from-all-skills-50k",
        num_workers=8,
        batch_size=8 * 32,
    ),
    TrainConfig(
