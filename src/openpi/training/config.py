...
_CONFIGS = [
    # smoke test config: K=1 short training for migration sanity checks
    TrainConfig(
        name="pi05_b1k-k1-smoke-step200",
    ...
    # smoke test config: K=6 short training for video memory migration checks
    TrainConfig(
