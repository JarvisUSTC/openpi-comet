...
# - peak_lr = 2.5e-5
# - num_train_steps = 30k
# - based on 3w training
#
# Usage:
#   bash submit_multinode_place_surface_stop_promptaug_30k_bs1024_lr2.5e-5_based_30k.sh
#
# Optional env vars:
...
EXP_NAME="${EXP_NAME:-ps_stopaug_mn_bs1024_lr1e5_30k_30k_$(date +%Y%m%d_%H%M%S)}"
NAME="${NAME:-${EXP_NAME}}"
if (( ${#NAME} > 64 )); then
  NAME="${NAME:0:64}"
fi
...
EXTRA_ARGS_DEFAULT=(
  ...
  "--weight-loader.params-path" "outputs/checkpoints/pi05_b1k-sampled_skill_group-stop-full-pretrained-prompt-aug/ps_stopaug_mn_bs1024_lr5e5_30k_20260402_213233/29999/params"
)
