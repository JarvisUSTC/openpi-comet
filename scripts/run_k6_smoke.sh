...
# K=6 smoke test launcher for JAX baseline with video memory.
# Usage:
#   bash scripts/run_k6_smoke.sh
# Optional env overrides:
#   CONFIG_NAME=pi05_b1k-k6-smoke-step200
#   EXP_NAME=k6_smoke_custom
#   OVERWRITE=true

CONFIG_NAME="${CONFIG_NAME:-pi05_b1k-k6-smoke-step200}"
EXP_NAME="${EXP_NAME:-k6_smoke_$(date +%Y%m%d_%H%M%S)}"
