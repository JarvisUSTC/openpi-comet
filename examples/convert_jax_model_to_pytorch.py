...
Example:
 # pi05_base
 python examples/convert_jax_model_to_pytorch.py --checkpoint_dir /root/Models/pi05_base --config_name pi05_b1k-all_skills --output_path /root/Models/pi05_base_pytorch
"""
...
def main(
    ...
    *,
    ...
    Args:
        ...
        config_name: Name of the training config to use for model configuration
